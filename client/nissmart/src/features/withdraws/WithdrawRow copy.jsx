...
import WithdrawForm from "../withdraws/WithdrawForm";
import { HiPencil } from "react-icons/hi2";
import Modal from "../../ui/Modal";
import Menus from "../../ui/Menus";
import WithdrawFundsBtn from "../withdraws/WithdrawButton";
            ...
            <Menus.Menu>
              ...
              <Menus.List id={id}>
                ...
                <Modal.Open opens="withdraw">
                  <Menus.Button icon={<HiPencil />}>Withdraw</Menus.Button>
                </Modal.Open>
              </Menus.List>
